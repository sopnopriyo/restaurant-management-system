...
public class BillManagement extends javax.swing.JFrame {
	...
	private void paymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentActionPerformed
		...
		this.dispose();
		try {
			PrintWriter pw1 = new PrintWriter(new FileOutputStream(classLoader.getResource("./data/temp.txt").getFile()));
			PrintWriter pw2 = new PrintWriter(new FileOutputStream(classLoader.getResource("./data/order.txt").getFile()));
			PrintWriter pw3 = new PrintWriter(new FileOutputStream(classLoader.getResource("./data/totalBill.txt").getFile(), true));
