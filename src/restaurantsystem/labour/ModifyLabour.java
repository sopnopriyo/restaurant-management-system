...
class MdfLabour {
	...
	private void openFile() {
		try {
			scan = new Scanner(new File(classLoader.getResource("./data/labour.txt").getFile()));
	...
	public void ModifyItem() {
		...
		try {
			Scanner sc = new Scanner(new FileInputStream(classLoader.getResource("./data/labour.txt").getFile()));
			...
			sc.close();
			sc = new Scanner(new FileInputStream(classLoader.getResource("./data/labour.txt").getFile()));
			while (sc.hasNextLine()) {
		...
		try {
			PrintWriter pw = new PrintWriter(new FileOutputStream(classLoader.getResource("./data/labour.txt").getFile()));
			for (int i = 0; i < c; i++) {
