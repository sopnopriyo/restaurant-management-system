...
class DltLabour {
	...
	public void deleteItem() {
		...
		try {
			Scanner sc = new Scanner(new File(classLoader.getResource("./data/labour.txt").getFile()));
			...
			sc.close();
			sc = new Scanner(new File(classLoader.getResource("./data/labour.txt").getFile()));
			while (sc.hasNextLine()) {
